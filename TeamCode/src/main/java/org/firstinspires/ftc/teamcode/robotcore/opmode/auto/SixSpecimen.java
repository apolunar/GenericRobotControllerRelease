...
@Autonomous
public class SixSpecimen extends CommandOpMode {
    ...
    public static Pose2d PRECISE_POSE_TOLERANCE = new Pose2d(1.0, 1.0, Rotation2d.fromDegrees(2));
    ...
    public static TrajectorySegment samplePusher(int sample) {
        ...
        return new TrajectorySegment( // to the sample
                ...
                new Translation2d[]{
                        new Translation2d(ObstacleMap.INCHES_PER_TILE + 5, sample == 0 ? 19 : lineupY),
                        new Translation2d(ObstacleMap.INCHES_PER_TILE * lineupX, sample == 2 ? lineupY - 3: lineupY),
    ...
    private static TrajectorySegment specimenCollection(int specimen) {
        return new TrajectorySegment( // to the loading area
                ...
                new Translation2d[0],
                new Pose2d(-0.5 - specimen / 6., sampleY(0) - 3, Rotation2d.fromDegrees(-180)),
                Rotation2d.fromDegrees(0),
    ...
    private static TrajectorySegment backToSpecimenCollection() {
        return new TrajectorySegment(
                ...
                new Translation2d[0],
                new Pose2d(8, sampleY(0) - 3, Rotation2d.fromDegrees(-180)),
                Rotation2d.fromDegrees(0),
    ...
    private static TrajectorySegment submersibleDeliverySystem(int specimen) {
        double yOffset = 1.5 * specimen;
        return new TrajectorySegment( // drive forward
                Rotation2d.fromDegrees(specimen == 0 ? 0 : -70),
                new Translation2d[]{
                        new Translation2d(12, -8 - yOffset)
                },
                ...
                new Pose2d(ObstacleMap.INCHES_PER_TILE + (specimen == 0 ? 10. : 10.5) + specimen / 3., -10 - yOffset, Rotation2d.fromDegrees(0)),
                Rotation2d.fromDegrees(0),
                specimen == 0 ? SLOW_TRAJECTORY_CONFIG : AutoConfig.TRAJECTORY_CONFIG
        );
    }
...
//        telemetry.addLine(String.format("Voltage offset: %s", voltageOffset));
        ...
        TrajectorySegment[] trajectorySegments = new TrajectorySegment[]{
                ...
                new TrajectorySegment(
                        ...
                        new Translation2d[0],
                        new Pose2d(8, sampleY(0) - 3, Rotation2d.fromDegrees(-90)),
                        Rotation2d.fromDegrees(0),
                        AutoConfig.TRAJECTORY_CONFIG
                ),
                ...
                backToSpecimenCollection(),
                // spec four
                specimenCollection(2),
                submersibleDeliverySystem(3),
                backToSpecimenCollection(),
                specimenCollection(3),
                submersibleDeliverySystem(4),
                parkTrajectory
        };

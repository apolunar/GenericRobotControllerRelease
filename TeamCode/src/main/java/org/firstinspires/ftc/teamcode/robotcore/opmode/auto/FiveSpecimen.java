...
public class FiveSpecimen extends CommandOpMode {
    ...
    public static TrajectorySegment samplePusher(int sample) {
        ...
        double lineupX = sample == 0 ? 2.4 : (sample == 1 ? 2.13 : 2.18);
    ...
    private static TrajectorySegment specimenCollection(int specimen) {
        return new TrajectorySegment( // to the loading area
                ...
                new Translation2d[0],
                new Pose2d(-0.5 - specimen / 4., sampleY(0) - 9, Rotation2d.fromDegrees(-180)),
                Rotation2d.fromDegrees(0),
    ...
    private static TrajectorySegment submersibleDeliverySystem(int specimen) {
        ...
        return new TrajectorySegment( // drive forward
                ...
                new Pose2d(ObstacleMap.INCHES_PER_TILE + (specimen == 0 ? 10. : 10.5) + specimen / 3.25, -10. - yOffset, Rotation2d.fromDegrees(0)),
                Rotation2d.fromDegrees(0),
...
//        telemetry.addLine(String.format("Voltage offset: %s", voltageOffset));
        ...
        TrajectorySegment[] trajectorySegments = new TrajectorySegment[]{
                ...
                new TrajectorySegment(
                        ...
                        new Translation2d[0],
                        new Pose2d(8, sampleY(0) - 9, Rotation2d.fromDegrees(-90)),
                        Rotation2d.fromDegrees(0),
                        AutoConfig.TRAJECTORY_CONFIG
                ),

...
public final class Units {
    ...
    private static final double kMillimetersPerInch = 25.4;
     ...
     * Converts given meters to feet.
     *
     * @param millimeters The millimeters to convert to inches.
     * @return Inches converted from millimeters.
     */
    public static double millimetersToInches(double millimeters) {
        return millimeters / kMillimetersPerInch;
    }
